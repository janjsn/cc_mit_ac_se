...
for scens = 1:length(obj.Bioenergy_rf_h)
    ...
    filename = [ 'Output/source_data/src_data_' obj.region_name '_' scen_description 'nat_reg_co2seq_per_year_with_std.mat'];
    
    save(filename, 'mean_abc_co2_seq_rate_ac', 'mean_soc_co2_seq_rate_ac', 'mean_co2_seq_per_ha_ac', 'std_co2_seq_per_ha_ac', 'mean_abc_co2_seq_rate_cropland_se', 'prod_land_ac',...
        'mean_soc_co2_seq_rate_cropland_se', 'mean_co2_seq_rate_cropland_se', 'std_co2_seq_per_ha_cropland_se', 'prod_land_cropland_se');
