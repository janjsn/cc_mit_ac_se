function wse_map =  get_wind_erosion(  )
%GET_WIND_EROSION Summary of this function goes here
%   Detailed explanation goes here

filename = 'Wind_Soil_Loss_Borrelli_GIS_WEQ_WGS84.tif';
