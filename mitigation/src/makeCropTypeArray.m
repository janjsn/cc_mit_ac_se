...
%Crop 5: Willow
CropTypeArray(5).name = 'Willow';
CropTypeArray(5).ID = 5;
CropTypeArray(5).description = 'Willow, bioenergy crop';
CropTypeArray(5).isBioenergyCrop = 1;
CropTypeArray(5).isFoodCrop = 0;
CropTypeArray(5).carbon_content_of_dry_mass = (0.4980*(1-0.01960)); % 0.498 of dry and ash free mass. Ash is 0.0196 of dry mass.
CropTypeArray(5).reference_carbon_content = 'Phyllis2';
CropTypeArray(5).nitrogen_content_of_dry_mass = 0.0062;
CropTypeArray(5).includeInPrimaryEnergyOptimization = 1;
CropTypeArray(5).cropParts_fractions_vectorized = 1;
CropTypeArray(5).cropParts_descriptions_cellArray = {'Whole plant'};
CropTypeArray(5).higherHeatingValue_vectorizedAfterCropPart_MJperKg = 19.84;
CropTypeArray(5).references_calorificValues_hhv = {'Phylis2 database, mean'};

CropTypeArray(5).lowerHeatingValue_vectorizedAfterCropPart_MJperKg = [18.49];
CropTypeArray(5).references_calorificValues_lhv = {'Phylis2 database, mean'};
